...
```{r fig.cap="Figure 1: Boxplot of Gene Expression of Samples", cache=TRUE}
Origin <- getGEO("GSE50834", GSEMatrix = TRUE)[[1]]
Pheno = pData(Origin)
Genes = fData(Origin)
Expression <- exprs(Origin)
...
```{r echo=TRUE, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
...
```{r fig.show = "hold", out.width = "50%", fig.align = "default",fig.cap="Figure 2. Support Vector Machine Scores for the Training Set. Left: The Published Paper. Right: Replication Result.", cache=TRUE }
